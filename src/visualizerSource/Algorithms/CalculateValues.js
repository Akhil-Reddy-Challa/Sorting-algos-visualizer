export default function CalculateValues() {
  /*
    ...
    1) It considers device_Width and subtracts 1px(From the screen_right)
    ...
    */
  let slider_max_value = Math.min(300, Math.floor((window.innerWidth - 1) / 3));
  ...
  /*
    ...
    2) Subtract 1px from width (From the screen_right)
